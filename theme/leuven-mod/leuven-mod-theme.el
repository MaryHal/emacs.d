;;; leuven-mod-theme.el --- Awesome Emacs color theme on white background
...
(let ((class '((class color) (min-colors 89)))
      ...
      (paren-matched '(:foreground "black" :background "#FFF876"))
  ...
  (custom-theme-set-faces
   ...
   `(minibuffer-prompt ((,class (:weight bold :foreground "#1A2F54"))))
   `(minibuffer-noticeable-prompt ((,class (:weight bold :foreground "#1A2F54"))))
   ...
   `(font-lock-comment-face ((,class (:foreground "#8D8D84")))) ; #696969
   ...
   `(header-line ((,class (:box "#542F1A" :foreground "#EB85CE" :background "#A8335E"))))
   ...
   `(anzu-mode-line ((,class (:inherit mode-line :weight bold :foreground "#FFB6C6"))))
   ...
   `(git-gutter:modified ((,class (:foreground "#0A99FF"))))
   `(git-gutter:added    ((,class (:foreground "#03C03C"))))
   `(git-gutter:deleted  ((,class (:foreground "#FF4040"))))
   ...
   `(helm-source-header ((,class (:family "Sans Serif" :height 1.3 :weight bold :underline t :foreground "#2F69BF" :background "white"))))
   ...
   `(sml/filename ((,class (:weight bold :foreground "#FFFF66"))))
   `(sml/folder ((,class (:foreground "#FFFF66"))))
   ;; `(sml/git ((,class (:weight bold :foreground "#FF5555"))))
   ;; `(sml/modes ((,class (:foreground ,minimal-aqua))))
   `(sml/modified ((,class (:foreground "#FF5555"))))
   ...
   `(sml/outside-modified ((,class (:foreground "#FF5555"))))
   `(sml/position-percentage ((,class (:foreground "#FFFF66"))))
   ...
   ;; `(sml/vc ((,class (:weight bold :foreground "#FF5555"))))
   ;; `(sml/vc-edited ((,class (:weight bold :foreground "#FF5555"))))
   `(sml/warning ((,class (:weight bold :foreground red))))
   ...
   `(trailing-whitespace ((,class (:background "#FFFF66"))))
...
(custom-theme-set-variables 'leuven-mod
