...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Company
   `(company-scrollbar-bg ((,class(:background ,nox-fg))))
   `(company-scrollbar-fg ((,class(:background ,nox-bg))))
   `(company-tooltip ((,class (:background ,nox-bg-dark :foreground ,nox-comment))))
   `(company-tooltip-annotation ((,class (:background ,nox-bg :foreground ,nox-special))))
   `(company-tooltip-common ((,class (:background ,nox-bg-dark :foreground ,nox-fg))))
   `(company-tooltip-common-selection ((,class (:background ,nox-bg-dark :foreground ,nox-fg))))
   `(company-tooltip-selection ((,class (:background ,nox-selection :foreground ,nox-em))))

   `(company-preview ((,class(:background ,nox-bg :foreground ,nox-cyan))))
