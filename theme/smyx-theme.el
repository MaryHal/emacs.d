...
(let ((class '((class color) (min-colors 89)))
 ...
 (custom-theme-set-faces
   ...
   `(lazy-highlight ((,class (:foreground ,smyx-black :background ,smyx-blue))))
   ...
   `(minibuffer-prompt ((,class (:foreground ,smyx-green+1))))

   ;; Smart Mode Line
   `(sml/col-number ((,class (:foreground ,smyx-fg))))
   `(sml/filename ((,class (:weight bold :foreground ,smyx-red))))
   `(sml/folder ((,class (:foreground ,smyx-gray))))
   `(sml/git ((,class (:weight bold :foreground ,smyx-blue))))
   `(sml/global ((,class (:foreground ,smyx-gray))))
   `(sml/line-number ((,class (:foreground ,smyx-yellow))))
   `(sml/modes ((,class (:foreground ,smyx-blue))))
   `(sml/modified ((,class (:foreground ,smyx-gray))))
   `(sml/mule-info ((,class (:foreground ,smyx-blue))))
   `(sml/not-modified ((,class (:foreground ,smyx-gray))))
   `(sml/numbers-separator ((,class (:foreground ,smyx-gray))))
   `(sml/outside-modified ((,class (:background ,smyx-red :foreground ,smyx-blue))))
   `(sml/position-percentage ((,class (:foreground ,smyx-yellow))))
   `(sml/prefix ((,class (:weight bold :foreground ,smyx-green))))
   `(sml/process ((,class (:weight bold :foreground ,smyx-green))))
   `(sml/read-only ((,class (:foreground ,smyx-blue))))
   `(sml/sudo ((,class (:background ,smyx-red :foreground ,smyx-blue))))
   `(sml/time ((,class (:foreground ,smyx-fg))))
   `(sml/vc ((,class (:foreground ,smyx-blue))))
   `(sml/vc-edited ((,class (:foreground ,smyx-red))))
   `(sml/warning ((,class (:weight bold :foreground ,smyx-red))))

   `(mode-line
     ((,class (:foreground ,smyx-fg
                           :background ,smyx-bg
                           :box nil))))
